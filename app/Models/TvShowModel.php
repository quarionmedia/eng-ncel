...
/**
     * Finds a single TV show by its primary key (ID).
     * This version uses a direct PDO connection to avoid "undefined method" errors.
     * @param int $id The ID of the TV show to find.
     * @return array|null The TV show as an associative array, or null if not found.
     */
    public function findById($id)
    {
        try {
            // We use the direct PDO instance from the __construct method.
