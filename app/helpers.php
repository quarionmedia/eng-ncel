...
/**
 * Scans the avatars directory and returns a list of available avatar filenames.
 *
 * @return array A list of avatar image files.
 */
function get_available_avatars() {
    $avatar_path = __DIR__ . '/../public/assets/images/avatars';
    $files = scandir($avatar_path);
    $avatars = [];
    foreach ($files as $file) {
        // Exclude '.' and '..' directories and ensure it's an image file
