...
private function makeRequest($endpoint, $params = []) {
    ...
    // --- NEW: Append additional parameters like the search query ---
...
/**
    ...
    {
        // "multi" search finds movies, tv shows, and people in one request.
        return $this->makeRequest("search/multi", ['query' => urlencode($query)]);
    }
}