...
<div class="hero-section" style="background-image: url('https://image.tmdb.org/t/p/original<?php echo $tvShow['backdrop_path']; ?>');">
    ...
    <div class="main-buttons">
        ...
        <?php endif; ?>
               <?php
// Kullanıcının izleme listesini ve bu dizinin listede olup olmadığını kontrol et
$isInWatchlist = false;
if (isset($_SESSION['user_id']) && isset($userWatchlist)) {
    foreach ($userWatchlist as $item) {
        if ($item['content_id'] == $tvShow['id'] && $item['content_type'] == 'tv_show') {
            $isInWatchlist = true;
            break;
        }
    }
...
<?php if (isset($_SESSION['user_id'])): ?>
    <button 
        class="btn btn-watchlist toggle-watchlist-btn <?php echo $isInWatchlist ? 'in-watchlist' : ''; ?>" 
        data-content-id="<?php echo $tvShow['id']; ?>" 
        data-content-type="tv_show">

        <i class="icon fas <?php echo $isInWatchlist ? 'fa-check' : 'fa-plus'; ?>"></i>
        <span class="btn-text"><?php echo $isInWatchlist ? 'Added to Watchlist' : 'Add Watchlist'; ?></span>
    </button>
<?php endif; ?>
        ...
        <a href="" id="report-content-btn" class="hero-action-btn"
   data-content-id="<?php echo $tvShow['id']; ?>"
   data-content-type="tv_show">
        <div class="icon-btn">
...
<div id="report-modal" class="report-modal">
    <div class="report-modal-content">
        ...
        <p>Please let us know what's wrong with this content. Our moderators will review your report.</p>
        ...
        <form id="report-form">
            ...
            <div class="report-form-group">
                ...
                <select id="report-reason" name="reason" required>
                    ...
                    <option value="video_not_working">Video not working</option>
                    <option value="wrong_content">Wrong movie/episode</option>
            ...
            <div class="report-form-group">
                <label for="report-info">Additional Information (optional):</label>
                <textarea id="report-info" name="additional_info" rows="4" placeholder="e.g., The video stops at 15:32, or the subtitles are out of sync."></textarea>
            </div>
