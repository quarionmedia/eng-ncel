...
<?php
// Kullanıcının izleme listesini ve bu filmin listede olup olmadığını kontrol et
$isInWatchlist = false;
if (isset($_SESSION['user_id']) && isset($userWatchlist)) {
    foreach ($userWatchlist as $item) {
        if ($item['content_id'] == $movie['id'] && $item['content_type'] == 'movie') {
            $isInWatchlist = true;
            break;
        }
    }
...
<?php if (isset($_SESSION['user_id'])): ?>
    <button 
        ...
        data-content-id="<?php echo $movie['id']; ?>" 
