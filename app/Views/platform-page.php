...
<div class="hover-genres">
    ...
    <?php endif; ?>
                                ...
                                <div class="hover-actions">
                                    <?php
                                        // --- WATCHLIST LOGIC ---
                                        // The content type is already set in the controller as $item['content_type']
                                        $type = $item['content_type'];
                                        $id = $item['id'];

                                        $isInWatchlist = false;
                                        // The $userWatchlist variable is now passed from the controller
                                        ...
                                        // Create the watch and detail URLs
                                        $watchUrl = $item['watch_url'] ?? (($type === 'movie') ? '/movie/' . $item['slug'] . '/watch' : '#');
                                        $detailUrl = '/' . $type . '/' . $item['slug'];
                                    ?>
