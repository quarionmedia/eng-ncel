...
<style>
    /* Enhanced Modern Add Movie Page with Rich Black-Gray Colors - Matching List Movies Design */
    :root {
        --primary-bg: #0a0a0a;
        --secondary-bg: #1a1a1a;
        --tertiary-bg: #2a2a2a;
    ...
    /* Enhanced TMDb Import Section - Matching List Movies Item Style */
    .tmdb-import-section {
        display: flex;
    ...
    .form-group label[for="release_date"]::before {
        content: '📅 ';
        margin-right: 4px;
    }

    .form-group label[for="runtime"]::before {
        content: '⏱️ ';
        margin-right: 4px;
    }
...
<main class="main-content">
    ...
    <div class="add-movie-header">
        <div class="add-movie-header-content">
            <div class="add-movie-title-section">
                <h1>
                    <div class="add-movie-title-icon">
        ...
        <div class="form-main">
            <form action="/admin/movies/add" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea id="overview" name="overview" rows="5" placeholder="Enter a detailed description of the movie..."></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="runtime" name="runtime" min="1" placeholder="120">
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Enhanced TMDb fetch functionality
    ...
    form.addEventListener('submit', function(e) {
        ...
        submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> Saving Movie...';
