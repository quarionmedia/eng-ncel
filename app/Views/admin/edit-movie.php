...
<style>
    /* Enhanced Modern Movie Edit Page with Rich Black-Gray Colors */
    :root {
        --primary-bg: #0a0a0a;
        --secondary-bg: #1a1a1a;
        --tertiary-bg: #2a2a2a;
                ...
                <div class="enhanced-card main-info">
                    ...
                    <div class="enhanced-card-content">
                        <div class="enhanced-form-group">
                            ...
                            <input type="text" id="title" name="title" required value="<?php echo htmlspecialchars($movie['title']); ?>" class="enhanced-form-input">
                        </div>
                        
                        <div class="enhanced-form-group">
                            <label for="overview">Description</label>
                            <textarea id="overview" name="overview" class="enhanced-form-textarea"><?php echo htmlspecialchars($movie['overview']); ?></textarea>
                        </div>
                        ...
                        <div class="enhanced-form-group">
                            ...
                            <input type="date" id="release_date" name="release_date" value="<?php echo $movie['release_date']; ?>" class="enhanced-form-input">
                        </div>
                        
                        <div class="enhanced-form-group">
                            <label for="runtime">Runtime</label>
                            <input type="text" id="runtime" name="runtime" value="<?php echo $movie['runtime']; ?>" placeholder="e.g., 95 min" class="enhanced-form-input">
                        </div>
                        
                        <div class="enhanced-form-group">
                            <label for="trailer_key_display">Trailer URL (YouTube Only)</label>
                            <input type="text" id="trailer_key_display" value="<?php echo !empty($movie['trailer_key']) ? 'https://www.youtube.com/watch?v=' . htmlspecialchars($movie['trailer_key']) : ''; ?>" placeholder="https://www.youtube.com/watch?v=..." class="enhanced-form-input">
                        </div>
                        ...
                        <div class="enhanced-media-grid">
                            ...
                            <div class="enhanced-media-item">
                                <div class="media-item-header">
                                    ...
                                    <h4 class="media-item-title">Thumbnail</h4>
                                </div>
                                ...
                                <div class="enhanced-media-controls">
                                    <input type="text" id="manual_backdrop_path" placeholder="Enter image URL..." value="https://image.tmdb.org/t/p/original<?php echo htmlspecialchars($movie['backdrop_path']); ?>">
                            ...
                            <div class="enhanced-media-item">
                                ...
                                <div class="enhanced-media-controls">
                                    <input type="text" id="manual_poster_path" placeholder="Enter image URL..." value="https://image.tmdb.org/t/p/original<?php echo htmlspecialchars($movie['poster_path']); ?>">
                            ...
                            <div class="enhanced-media-item">
                                <div class="media-item-header">
                                    ...
                                    <h4 class="media-item-title">Texted Backdrop (for Lists)</h4>
                                </div>
                                ...
                                <div class="enhanced-media-controls">
                                    <input type="text" id="manual_logo_backdrop_path" placeholder="Enter backdrop URL..." value="https://image.tmdb.org/t/p/original<?php echo htmlspecialchars($movie['logo_backdrop_path'] ?? ''); ?>">
                            ...
                            <div class="enhanced-media-item">
                                ...
                                <div class="enhanced-media-controls">
                                    <input type="text" id="manual_logo_path" placeholder="Enter logo URL..." value="https://image.tmdb.org/t/p/original<?php echo htmlspecialchars($movie['logo_path'] ?? ''); ?>">
                            ...
                            <div class="enhanced-media-item">
                                <div class="media-item-header">
                                    ...
                                    <h4 class="media-item-title">Trailer URL (YouTube Only)</h4>
                                </div>
                                    ...
                                    <?php if (!empty($movie['trailer_key'])): ?>
                                        <div style="text-align: center;">
                                            ...
                                            <p style="color: var(--text-primary); margin: 0;">
                                                <a href="https://www.youtube.com/watch?v=<?php echo htmlspecialchars($movie['trailer_key']); ?>" target="_blank" style="color: var(--accent-gold); text-decoration: none;">Watch Current Trailer</a>
                                            </p>
                                        </div>
                                    <?php else: ?>
                                ...
                                <div class="enhanced-media-controls">
                                    <input type="text" id="manual_trailer_key" placeholder="YouTube URL or video ID..." value="<?php echo !empty($movie['trailer_key']) ? 'https://www.youtube.com/watch?v=' . htmlspecialchars($movie['trailer_key']) : ''; ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Trailer URL handling - convert full URL to key for hidden input
    ...
    if (trailerInput && hiddenTrailerInput) {
        trailerInput.addEventListener('input', function() {
            ...
            if (url.includes('youtube.com/watch?v=')) {
                ...
                videoId = url; // If only ID is entered
            }
