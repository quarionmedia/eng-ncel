...
<style>
    /* Enhanced Modern Movies List Page with Rich Black-Gray Colors */
    :root {
        --primary-bg: #0a0a0a;
        --secondary-bg: #1a1a1a;
        --tertiary-bg: #2a2a2a;
...
.enhanced-content-item:hover {
    ...
    /* transform: translateY(-4px) translateX(4px); */ /* Bu satırı silin */
...
<main class="main-content">
    ...
    <div class="list-header">
        <div class="list-header-content">
            ...
            <a href="/admin/movies/add" class="add-new-link">
        ...
        <?php if (!empty($movies)): ?>
            <?php foreach ($movies as $movie): ?>
                <div class="enhanced-content-item">
                    <img src="https://image.tmdb.org/t/p/w200<?php echo $movie['poster_path']; ?>" alt="Movie Poster" class="enhanced-content-poster">
                    
                    <div class="enhanced-content-info">
                        <h3 class="enhanced-content-title"><?php echo htmlspecialchars($movie['title']); ?></h3>
                        <p class="enhanced-content-description"><?php echo htmlspecialchars(substr($movie['overview'], 0, 200)); ?>...</p>
                    </div>
                    ...
                    <div class="enhanced-content-actions">
                        ...
                        <div class="enhanced-options-dropdown">
                            <a href="/admin/movies/edit/<?php echo $movie['id']; ?>">
                                <i class="fas fa-edit"></i>
                                Edit Movie
                            </a>
                            <a href="/admin/manage-movie-links/<?php echo $movie['id']; ?>">
                            ...
                            <a href="/admin/movies/delete/<?php echo $movie['id']; ?>" onclick="return confirm('Are you sure you want to delete this movie?');" class="delete">
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <div class="no-movies-state">
                <i class="fas fa-film"></i>
                <h3>No Movies Found</h3>
                <p>Start building your movie collection by adding your first movie to the platform.</p>
            </div>
        <?php endif; ?>
    </div>
</main>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.enhanced-options-dropdown a.delete').forEach(deleteBtn => {
        deleteBtn.addEventListener('click', function(e) {
            const movieTitle = this.closest('.enhanced-content-item').querySelector('.enhanced-content-title').textContent;
            const confirmDelete = confirm(`⚠️ Are you sure you want to delete "${movieTitle}"?\n\nThis action cannot be undone and will remove all associated data.`);
            if (!confirmDelete) {
                e.preventDefault();
                return false;
            }
