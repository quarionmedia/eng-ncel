...
<style>
    /* Enhanced Modern Subtitles Management Page with Rich Black-Gray Colors */
    :root {
        --primary-bg: #0a0a0a;
        --secondary-bg: #1a1a1a;
        --tertiary-bg: #2a2a2a;
    ...
    .options-dropdown button::before {
        content: '✏️';
    }
    ...
    .options-dropdown a[style*="color: #ff4d4d"]::before {
        content: '🗑️';
    }
...
<main>
    <h1>Subtitle Manager for Link #<?php echo $link['id']; ?> <em>(<?php echo htmlspecialchars($context['parent']['title'] ?? $context['parent']['name']); ?>)</em></h1>
    ...
    <table class="admin-table">
        ...
        <tbody>
            <?php if (!empty($subtitles)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <tr><td colspan="5" class="no-subtitles-row">No subtitles found for this link.</td></tr>
            <?php endif; ?>
        </tbody>
    </table>
</main>
